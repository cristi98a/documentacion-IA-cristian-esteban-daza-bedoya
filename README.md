...
- **Autor:** cristian *esteban* daza bedoya
...
- **Rol**:eres un experto desarrollador de sofware

- **Tarea**: quiero que creesun roadmap para aprender springboot desde cero

- **contexto** soy un estudiante de ia segundo semestre tengo 20 años
...
- **rol**: eres un profesor de musica

- **tarea**: quiero que hagas un plan de estudio sobre las notas y las figuras musicales

- **contexto**: es para niños de septimo secundaria
...
- **rol**:piensa como un entrenador exigente de <span style="color:#679C73">futbol</span>

- **tarea**:haz ejercicios para mejorar la velocidad en futbol

- **contexto**:es para adolecentes de 16 años
...
- **rol**:pinsa como un gamer profecional

- **tarea**:dime los 5 mejores juegos para pc

- **contexto**:es para una competencia y ganar 1 millon de pesos
...
- **rol**:piensa como un chef que cocina la comida mas rica del mundo

- **tarea**:haz un platillo facil de hacer pero que sea muy rico

- **contexto**:es para impresionar a toda mi familia
...
- **rol**:piensa como un programador profecional que tiene muchos años programando videojuegos

- **tarea**:dime 5 paginas con ia para crear los mejores videojuegos

- **contexto**:es para un proyecto final de mi uni de programacion
